...
$("head").append('<style>.chat-updubed{color: cyan;}.chat-downdubed{color: magenta;}.chat-plus-users{top: -.5em;color: white;}</style>');
...
var lastUpdubLog, lastUpdubLogTotal;
var lastDowndubLog, lastDowndubLogTotal;
function dbe_init() {
